...
$ns duplex-link-op $n1 orient right
$ns duplex-link-op $n2 orient left
$ns duplex-link-op $n3 orient right-up
$ns duplex-link-op $n4 orient right-down
$ns duplex-link-op $n5 orient left-up
$ns duplex-link-op $n6 orient left-down

Agent/Ping inst proc recv { from rtt}{
$self inst var node
